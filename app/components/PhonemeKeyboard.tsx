...
type PhonemeKeyboardProps = {
  ...
  /** When false, hover/focus hints are not shown (a harder difficulty option). Defaults to true. */
  showHints?: boolean;
};
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={showHints ? `${phoneme.symbol}, ${phoneme.hint}` : phoneme.symbol}
        aria-describedby={showHints ? tooltipId : undefined}
